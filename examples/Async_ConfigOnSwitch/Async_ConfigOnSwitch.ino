...
void setup()
{
  ...
  Serial.println(ASYNC_ESP32_ETH_MANAGER_VERSION);
...
#if ( USING_ESP32_S2 || USING_ESP32_C3 )
  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&webServer, NULL, "AsyncConfigOnSwitch");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&webServer, &dnsServer, "AsyncConfigOnSwitch");
#endif

  AsyncESP32_Ethernet_manager.setDebugOutput(true);

#if !USE_DHCP_IP
  // Set (static IP, Gateway, Subnetmask, DNS1 and DNS2) or (IP, Gateway, Subnetmask)
  AsyncESP32_Ethernet_manager.setSTAStaticIPConfig(EthSTA_IPconfig);
#endif
  ...
  if (initialConfig)
  {
    ...
    //AsyncESP32_Ethernet_manager.setConfigPortalTimeout(600);
