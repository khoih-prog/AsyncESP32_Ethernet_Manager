...
void setup()
{
  ...
  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&webServer, NULL, "AsyncConfigOnDoubleReset");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&webServer, &dnsServer, "AsyncConfigOnDoubleReset");
#endif
