...
void setup()
{
  ...
  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&webServer, NULL, "AsyncCP-ParamsOnSW");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&webServer, &dnsServer, "AsyncCP-ParamsOnSW");
#endif
