...
void setup()
{
  ...
  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&server, NULL, "AsyncESP32-FSWebServer");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_Ethernet_Manager AsyncESP32_Ethernet_manager(&server, &dnsServer, "AsyncESP32-FSWebServer");
#endif
